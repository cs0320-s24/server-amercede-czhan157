...
public class BroadbandPercent {
  ...
  public BroadbandPercent(String stateNum, String countyNum)
  ...
  public String sendRequestForTheBroadbandPercent(String stateNum, String countyNum)
  ...
  private List<List<String>> deserializeBroadbandPercent(String jsonList)
