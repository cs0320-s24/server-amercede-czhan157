...
public interface Cache {
  ...
  default List<List<String>> BroadbandPercent(String stateNum, String countyNum)
    ...
    List<List<String>> theListOfBroadbandPercent = this.deserializeBroadbandPercent(stateCode);
    return theListOfBroadbandPercent;
  }

  default String sendRequestForTheBroadbandPercent(String stateNum, String countyNum)
  ...
  default List<List<String>> deserializeBroadbandPercent(String jsonList)
