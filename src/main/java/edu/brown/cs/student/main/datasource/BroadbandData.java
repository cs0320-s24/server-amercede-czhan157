...
public record BroadbandData() {
  ...
  /**
   * This makes our client and request and This will return a string that represents a response to
   * our query
   *
   * @return
   */
   ...
   */
  public static Broadband deserializeBroadband(String jsonList)
